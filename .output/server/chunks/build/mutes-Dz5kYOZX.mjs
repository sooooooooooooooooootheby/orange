...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, error } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("mutes", () => $fetch("/api/litebans/mutes"))), __temp = await __temp, __restore(), __temp);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/bans/mutes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=mutes-Dz5kYOZX.mjs.map
