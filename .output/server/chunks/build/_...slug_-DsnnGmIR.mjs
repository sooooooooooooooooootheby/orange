...
import { d as useAppConfig, k as useRoute, l as useAsyncData, m as createError, b as useSeoMeta, n as __nuxt_component_7$1, o as _sfc_main$9, p as _sfc_main$8, j as tryUseNuxtApp, t as tv, f as useLocale, g as useRouter, h as useNuxtApp, i as _sfc_main$y, e as useRuntimeConfig } from './server.mjs';
import { E as pascalCase, F as kebabCase, v as withoutTrailingSlash, f as destr } from '../nitro/nitro.mjs';
...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.1_@babel+parser@7.28.3_change-case@5.4.4_db0@0.3.2_better-sqlite3@_2f07df7ffe6b8d13a95399386992709b/node_modules/@nuxt/ui/dist/runtime/components/Page.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.1_@babel+parser@7.28.3_change-case@5.4.4_db0@0.3.2_better-sqlite3@_2f07df7ffe6b8d13a95399386992709b/node_modules/@nuxt/ui/dist/runtime/components/PageAside.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.1_@babel+parser@7.28.3_change-case@5.4.4_db0@0.3.2_better-sqlite3@_2f07df7ffe6b8d13a95399386992709b/node_modules/@nuxt/ui/dist/runtime/components/PageBody.vue");
...
const Admin = () => import('./admin-CdUKdkrs.mjs');
const Guild = () => import('./guild-DGSSD7CG.mjs');
...
const virtual_nuxt__2FUsers_2Faliceclodia_2FDesktop_2Forange_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Admin,
  Guild,
  globalComponents,
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2FUsers_2Faliceclodia_2FDesktop_2Forange_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.1_@babel+parser@7.28.3_change-case@5.4.4_db0@0.3.2_better-sqlite3@_2f07df7ffe6b8d13a95399386992709b/node_modules/@nuxt/ui/dist/runtime/components/content/ContentToc.vue");
...
const __nuxt_component_8_lazy = defineAsyncComponent(() => import('./ContentSearch-BMQslxdz.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=_...slug_-DsnnGmIR.mjs.map
