import { _ as _sfc_main$2 } from './Alert-6Z56cRp8.mjs';
import { _ as _sfc_main$3 } from './Input-5fThu2tf.mjs';
import { defineComponent, withAsyncContext, ref, computed, unref, isRef, useSlots, toRef, mergeProps, withCtx, createBlock, createCommentVNode, renderSlot, openBlock, Fragment, renderList, toDisplayString, createTextVNode, createVNode, useSSRContext } from 'vue';
...
import { d as useAsyncData, e as _sfc_main$a, g as useAppConfig, h as usePortal, i as useFormField, j as useFieldGroup, k as useComponentIcons, t as tv, l as isArrayOfArray, m as _sfc_main$y, n as _sfc_main$w, o as get, p as _sfc_main$x, q as getDisplayValue } from './server.mjs';
                                          ...
                                          ssrRenderSlot(_ctx.$slots, "item", {
                                            ...
                                            ssrRenderSlot(_ctx.$slots, "item-leading", {
                                              ...
                                              if (isSelectItem(item) && item.icon) {
                                                _push6(ssrRenderComponent(_sfc_main$y, {
                                                  name: item.icon,
                                                ...
                                                _push6(ssrRenderComponent(_sfc_main$w, mergeProps({
                                                ...
                                                _push6(ssrRenderComponent(_sfc_main$x, mergeProps({
                                          ...
                                          return [
                                            renderSlot(_ctx.$slots, "item", {
                                              ...
                                              renderSlot(_ctx.$slots, "item-leading", {
                                                ...
                                                isSelectItem(item) && item.icon ? (openBlock(), createBlock(_sfc_main$y, {
                                                  key: 0,
                                                  name: item.icon,
                                                  class: ui.value.itemLeadingIcon({ class: [props.ui?.itemLeadingIcon, item.ui?.itemLeadingIcon] })
                                                }, null, 8, ["name", "class"])) : isSelectItem(item) && item.avatar ? (openBlock(), createBlock(_sfc_main$w, mergeProps({
                                                  key: 1,
                                                  size: item.ui?.itemLeadingAvatarSize || props.ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize()
                                                }, { ref_for: true }, item.avatar, {
                                                  class: ui.value.itemLeadingAvatar({ class: [props.ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar] })
                                                }), null, 16, ["size", "class"])) : isSelectItem(item) && item.chip ? (openBlock(), createBlock(_sfc_main$x, mergeProps({
                                                  key: 2,
                                                  size: item.ui?.itemLeadingChipSize || props.ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                                  inset: "",
                                                  standalone: ""
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.1_@bab_01b8e4c3f51a2b4e0cb534dba2e2c4de/node_modules/@nuxt/ui/dist/runtime/components/Select.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, error } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("kicks", () => $fetch("/api/litebans/kicks"))), __temp = await __temp, __restore(), __temp);
    const nameValue = ref("");
    const sortItems = ref([
      {
        label: "踢出次数从高到低",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(error)) {
        ...
        _push(`<div><div class="mb-3 flex flex-col gap-2">`);
        _push(ssrRenderComponent(_component_UInput, {
          modelValue: unref(nameValue),
          "onUpdate:modelValue": ($event) => isRef(nameValue) ? nameValue.value = $event : null,
          placeholder: "搜索玩家..."
        }, null, _parent));
        _push(ssrRenderComponent(_component_USelect, {
          modelValue: unref(sortValue),
          "onUpdate:modelValue": ($event) => isRef(sortValue) ? sortValue.value = $event : null,
          items: unref(sortItems),
          class: "w-48"
        }, null, _parent));
        ...
        ssrRenderList(unref(filteredData), (item) => {
          ...
          _push(`<p> 累计被踢出次数: <span class="font-bold">${ssrInterpolate(item.kick_count)}</span></p><ul class="text-sm text-gray-500"><!--[-->`);
          ssrRenderList(item.kick, (kick) => {
            _push(`<li class="list-inside list-disc">${ssrInterpolate(kick.reason)} x${ssrInterpolate(kick.reason_count)}</li>`);
          });
          _push(`<!--]--></ul></div></div>`);
        });
        _push(`<!--]--></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/bans/kicks.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=kicks-DMEMcsMD.mjs.map
