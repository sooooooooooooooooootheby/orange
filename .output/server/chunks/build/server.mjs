...
const _sfc_main$w = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$x : unref(Primitive)), mergeProps({ as: __props.as }, props.chip ? typeof props.chip === "object" ? { inset: true, ...props.chip } : { inset: true } : {}, {
        class: ui.value.root({ class: [props.ui?.root, props.class] }),
        style: props.style
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            return [
              __props.custom ? renderSlot(_ctx.$slots, "default", mergeProps({ key: 0 }, {
                ...
                isExternal,
                active: isLinkActive({ route: linkRoute, isActive, isExactActive })
              })) : (openBlock(), createBlock(_sfc_main$v, mergeProps({ key: 1 }, {
                ..._ctx.$attrs,
                ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                as: __props.as,
                type: __props.type,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$u, mergeProps({
        ...
        default: withCtx(({ active, ...slotProps }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$v, mergeProps(slotProps, {
              class: ui.value.base({
                ...
                if (_push3) {
                  ssrRenderSlot(_ctx.$slots, "leading", {}, () => {
                    if (unref(isLeading) && unref(leadingIconName)) {
                      ...
                      _push3(ssrRenderComponent(_sfc_main$w, mergeProps({
            ...
            return [
              createVNode(_sfc_main$v, mergeProps(slotProps, {
                class: ui.value.base({
                  class: [props.ui?.base, props.class],
                  active,
                  ...active && __props.activeVariant ? { variant: __props.activeVariant } : {},
            ...
            _push2(ssrRenderComponent(unref(TooltipProvider), tooltipProps.value, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$p, null, null, _parent3, _scopeId2));
                } else {
                  return [
...
const _sfc_main$m = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const { t } = useLocale();
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$e), ...appConfig2.ui?.banner || {} })({
      color: props.color,
      to: !!props.to
    }));
    ...
    function onClose() {
      ...
      (void 0).querySelector("html")?.classList.add("hide-banner");
      emits("close");
    }
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
        class: ["banner", ui.value.root({ class: [props.ui?.root, props.class] })]
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$u, mergeProps({ "aria-label": __props.title }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
                ...
                if (_push3) {
                  ...
                  ssrRenderSlot(_ctx.$slots, "close", { ui: ui.value }, () => {
                    if (__props.close) {
                      _push3(ssrRenderComponent(_sfc_main$t, mergeProps({
                        ...
                        color: "neutral",
                        variant: "ghost",
                        "aria-label": unref(t)("banner.close")
                      }, typeof __props.close === "object" ? __props.close : {}, {
                        class: ui.value.close({ class: props.ui?.close }),
                        onClick: onClose
                      }), null, _parent3, _scopeId2));
                  ...
                  return [
                    ...
                    createVNode("div", {
                      ...
                      __props.actions?.length ? (openBlock(), createBlock("div", {
                        key: 1,
                        class: ui.value.actions({ class: props.ui?.actions })
                      }, [
                        renderSlot(_ctx.$slots, "actions", {}, () => [
            ...
            return [
              __props.to ? (openBlock(), createBlock(_sfc_main$u, mergeProps({
                key: 0,
...
const _sfc_main$l = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$d), ...appConfig2.ui?.slideover || {} })({
                                  ...
                                  default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      ssrRenderSlot(_ctx.$slots, "close", {
                                        ...
                                        if (props.close) {
                                          _push5(ssrRenderComponent(_sfc_main$t, mergeProps({
                                            icon: __props.closeIcon || unref(appConfig2).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, "close", {
                                          ...
                                          props.close ? (openBlock(), createBlock(_sfc_main$t, mergeProps({
                                            key: 0,
                                            icon: __props.closeIcon || unref(appConfig2).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
...
const _sfc_main$k = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$c), ...appConfig2.ui?.modal || {} })({
      transition: props.transition,
...
const _sfc_main$j = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$b), ...appConfig2.ui?.drawer || {} })({
...
const _sfc_main$i = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$a), ...appConfig2.ui?.header || {} })());
    const Menu = computed(() => ({
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", {
                ...
                __props.toggle ? (openBlock(), createBlock(_sfc_main$t, mergeProps({
                  key: 0,
                  color: "neutral",
                  variant: "ghost",
                  "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex items-center gap-1" }, _attrs))}><img${ssrRenderAttr("src", _imports_0)} alt="orange" class="w-6"><p>OrangeCraftMC</p></div>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$1]]), { __name: "Logo" });
const theme$9 = {
  "slots": {
...
const _sfc_main$g = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$9), ...appConfig2.ui?.badge || {} })({
      color: props.color,
      variant: props.variant,
...
const _sfc_main$f = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$8), ...appConfig2.ui?.popover || {} })({
...
const _sfc_main$e = {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$7), ...appConfig2.ui?.kbd || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
...
const _sfc_main$d = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const contentProps = toRef(() => defu(props.content, { side: "bottom", sideOffset: 8, collisionPadding: 8 }));
    const arrowProps = toRef(() => props.arrow);
    const ui = computed(() => tv({ extend: tv(theme$6), ...appConfig2.ui?.tooltip || {} })({
      side: contentProps.value.side
    }));
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$c = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig2.ui?.navigationMenu || {} })({
      orientation: props.orientation,
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$w, mergeProps({
                    key: 0,
                    size: item.ui?.linkLeadingAvatarSize || props.ui?.linkLeadingAvatarSize || ui.value.linkLeadingAvatarSize()
                  }, item.avatar, {
                    class: ui.value.linkLeadingAvatar({ class: [props.ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.orientation === "vertical" && item.type === "label" && !__props.collapsed) {
                    ...
                    _push3(ssrRenderComponent(_sfc_main$u, mergeProps(__props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                            ...
                            default: withCtx((_2, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                if (__props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover)) {
                                  _push5(ssrRenderComponent(_sfc_main$f, mergeProps({ ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                      ...
                                      if (_push6) {
                                        ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                          ...
                                          ssrRenderList(item.children, (childItem, childIndex) => {
                                            ...
                                            _push6(ssrRenderComponent(_sfc_main$u, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(unref(NavigationMenuLink), {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$v, mergeProps({ ref_for: true }, childSlotProps, {
                                                        ...
                                                        return [
                                                          createVNode(_sfc_main$v, mergeProps({ ref_for: true }, childSlotProps, {
                                                            class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                          }), {
                                                            default: withCtx(() => [
                                                              childItem.icon ? (openBlock(), createBlock(_sfc_main$y, {
                                            ...
                                            createVNode("ul", {
                                              ...
                                              (openBlock(true), createBlock(Fragment, null, renderList(item.children, (childItem, childIndex) => {
                                                return openBlock(), createBlock("li", {
                                                  ...
                                                  createVNode(_sfc_main$u, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                    ...
                                    default: withCtx((_3, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$v, mergeProps(slotProps, {
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$v, mergeProps(slotProps, {
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$f, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ui: { content: ui.value.content({ class: [props.ui?.content, item.ui?.content] }) }
                                  }), {
                                    content: withCtx(() => [
                                      renderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : __props.orientation === "vertical" && __props.collapsed && (!!props.tooltip || !!item.tooltip) ? (openBlock(), createBlock(_sfc_main$d, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, props.labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
                                    ...
                                    _: 2
                                  }, 1040, ["text"])) : (openBlock(), createBlock(_sfc_main$v, mergeProps({ key: 2 }, slotProps, {
                                    class: ui.value.link({ class: [props.ui?.link, item.ui?.link, item.class], active: active || item.active, disabled: !!item.disabled, level: __props.orientation === "horizontal" || level > 0 })
                                  }), {
                                    default: withCtx(() => [
                                      createVNode(unref(ReuseLinkTemplate), {
                                ...
                                if (_push5) {
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                    ...
                                    ssrRenderList(item.children, (childItem, childIndex) => {
                                      ...
                                      _push5(ssrRenderComponent(_sfc_main$u, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(NavigationMenuLink), {
                                              ...
                                              default: withCtx((_3, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$v, mergeProps({ ref_for: true }, childSlotProps, {
                                                    class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                  }), {
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$u, mergeProps({ key: 1 }, __props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig2.ui?.separator || {} })({
      color: props.color,
      orientation: props.orientation,
      size: props.size,
      type: props.type
                ...
                createVNode("div", {
                  ...
                  renderSlot(_ctx.$slots, "default", {}, () => [
                    __props.label ? (openBlock(), createBlock("span", {
                      key: 0,
                      class: ui.value.label({ class: props.ui?.label })
                    }, toDisplayString(__props.label), 3)) : __props.icon ? (openBlock(), createBlock(_sfc_main$y, {
                      key: 1,
                      name: __props.icon,
                      class: ui.value.icon({ class: props.ui?.icon })
                    }, null, 8, ["name", "class"])) : __props.avatar ? (openBlock(), createBlock(_sfc_main$w, mergeProps({
...
const _sfc_main$9 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$3), ...appConfig2.ui?.contentSearchButton || {} })());
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
...
const _sfc_main$8 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const appConfig2 = useAppConfig();
    const [DefineLinkTemplate, ReuseLinkTemplate] = createReusableTemplate();
    const ui = computed(() => tv({ extend: tv(theme$2), ...appConfig2.ui?.contentNavigation || {} })({
      color: props.color,
      variant: props.variant,
      highlight: props.highlight,
      highlightColor: props.highlightColor || props.color
            ...
            return [
              renderSlot(_ctx.$slots, "link", {
                ...
                renderSlot(_ctx.$slots, "link-leading", {
                  ...
                  link.icon ? (openBlock(), createBlock(_sfc_main$y, {
                    key: 0,
                    name: link.icon,
                    class: ui.value.linkLeadingIcon({ class: [props.ui?.linkLeadingIcon, link.ui?.linkLeadingIcon], active })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                ...
                link.title || !!slots["link-title"] ? (openBlock(), createBlock("span", {
                  ...
                  link.target === "_blank" ? (openBlock(), createBlock(_sfc_main$y, {
                    key: 0,
                    name: unref(appConfig2).ui.icons.external,
                    class: ui.value.linkTitleExternalIcon({ class: [props.ui?.linkTitleExternalIcon, link.ui?.linkTitleExternalIcon], active })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                ...
                link.badge || link.children?.length && !__props.disabled || link.trailingIcon || !!slots["link-trailing"] ? (openBlock(), createBlock("span", {
                  ...
                  renderSlot(_ctx.$slots, "link-trailing", {
                    ...
                    link.badge ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                      key: 0,
                      color: "neutral",
                      variant: "outline",
                      size: props.ui?.linkTrailingBadgeSize || ui.value.linkTrailingBadgeSize()
                    ...
                    link.children?.length && !__props.disabled ? (openBlock(), createBlock(_sfc_main$y, {
                      key: 1,
                      name: link.trailingIcon || __props.trailingIcon || unref(appConfig2).ui.icons.chevronDown,
                      class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, link.ui?.linkTrailingIcon] })
                    }, null, 8, ["name", "class"])) : link.trailingIcon ? (openBlock(), createBlock(_sfc_main$y, {
                      key: 2,
                      name: link.trailingIcon,
                      class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, link.ui?.linkTrailingIcon] })
                    }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                ...
                if (_push3) {
                  ...
                  ssrRenderList(__props.navigation, (link, index2) => {
                    ...
                    if (link.children?.length) {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ...
                            _push4(ssrRenderComponent(unref(AccordionContent), {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(ssrRenderComponent(_sfc_main$8, mergeProps({ ref_for: true }, unref(rootProps), {
                                  ...
                                  return [
                                    createVNode(_sfc_main$8, mergeProps({ ref_for: true }, unref(rootProps), {
                                      navigation: link.children,
                                      "default-open": __props.defaultOpen,
                                      level: __props.level + 1,
                                      "trailing-icon": __props.trailingIcon,
                      ...
                      _push3(ssrRenderComponent(_sfc_main$u, mergeProps({ ref_for: true }, unref(pickLinkProps)(unref(mapContentNavigationItem)(link)), { custom: "" }), {
                        default: withCtx(({ active, ...slotProps }, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(_sfc_main$v, mergeProps({ ref_for: true }, slotProps, {
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.navigation, (link, index2) => {
                      return openBlock(), createBlock(Fragment, { key: index2 }, [
                        link.children?.length ? (openBlock(), createBlock(unref(AccordionItem), {
                          ...
                          createVNode(_sfc_main$u, mergeProps({ ref_for: true }, unref(pickLinkProps)(unref(mapContentNavigationItem)(link)), { custom: "" }), {
                            default: withCtx(({ active, ...slotProps }) => [
                              createVNode(_sfc_main$v, mergeProps({ ref_for: true }, slotProps, {
                                class: ui.value.link({ class: [props.ui?.link, link.ui?.link, link.class], active, disabled: !!link.disabled, level: __props.level > 0 })
                              }), {
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UNavigationMenu = _sfc_main$c;
      const _component_UColorModeButton = _sfc_main$b;
      ...
      _push(ssrRenderComponent(_component_UHeader, mergeProps({ mode: "slideover" }, _attrs), {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UNavigationMenu, {
              items: unref(appConfig2).route,
              orientation: "vertical"
            }, null, _parent2, _scopeId));
            if (unref(route).path.includes("docs")) {
              _push2(`<div${_scopeId}>`);
              if (unref(route).path.includes("docs")) {
                _push2(ssrRenderComponent(_component_USeparator, { class: "my-4" }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
              ...
              if (unref(route).path.includes("docs")) {
                _push2(ssrRenderComponent(_component_UContentNavigation, {
                  type: "single",
                  navigation: unref(appConfig2).navigation
                }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
            ...
            return [
              ...
              unref(route).path.includes("docs") ? (openBlock(), createBlock("div", { key: 0 }, [
                unref(route).path.includes("docs") ? (openBlock(), createBlock(_component_USeparator, {
                  key: 0,
                  class: "my-4"
                })) : createCommentVNode("", true),
...
const __nuxt_component_2 = Object.assign(_sfc_main$7, { __name: "AppHeader" });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Icon = __nuxt_component_1$2;
  _push(ssrRenderComponent(_component_UFooter, mergeProps({ class: "bg-default border-t border-default py-4" }, _attrs), {
    left: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="flex flex-col items-center md:items-start"${_scopeId}><p class="text-muted text-sm"${_scopeId}>Copyright © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Orangecraftmc</p><p class="text-muted text-sm"${_scopeId}>鄂ICP备2025144636号</p></div>`);
      } else {
        return [
          createVNode("div", { class: "flex flex-col items-center md:items-start" }, [
            createVNode("p", { class: "text-muted text-sm" }, "Copyright © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " Orangecraftmc", 1),
            createVNode("p", { class: "text-muted text-sm" }, "鄂ICP备2025144636号")
          ])
        ];
      }
    }),
    right: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<a href="https://space.bilibili.com/1915573443?spm_id_from=333.788.upinfo.detail.click" target="_blank"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_Icon, {
          name: "mingcute:bilibili-fill",
          class: "text-xl text-gray-400 duration-300 hover:text-gray-500"
        }, null, _parent2, _scopeId));
        _push2(`</a>`);
      } else {
        return [
          createVNode("a", {
            href: "https://space.bilibili.com/1915573443?spm_id_from=333.788.upinfo.detail.click",
            target: "_blank"
          }, [
...
const __nuxt_component_7 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender]]), { __name: "AppFooter" });
const _sfc_main$3 = {
  __name: "Search",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<canvas${ssrRenderAttrs(mergeProps({ id: "confetti-canvas" }, _attrs))}></canvas>`);
    };
  }
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UBanner = __nuxt_component_1$1;
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UBanner, {
              title: "🎉 Hi~ 欢迎来到橙子工艺官网, 如果你在网站中发现任何问题请联系 AliceIClodia.",
              close: ""
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_appHeader, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_NuxtLoadingIndicator, { color: "#F8BB77" }, null, _parent2, _scopeId));
                  ...
                  _push3(ssrRenderComponent(_component_NuxtLayout, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="pattern-dots-md fixed top-0 left-0 -z-1 h-screen w-screen text-gray-200 dark:text-gray-600"${_scopeId3}></div>`);
                      } else {
                        return [
                          createVNode(_component_NuxtPage),
                          createVNode("div", { class: "pattern-dots-md fixed top-0 left-0 -z-1 h-screen w-screen text-gray-200 dark:text-gray-600" })
                        ];
                      }
                    }),
                    _: 1
            ...
            return [
              createVNode(_component_UBanner, {
                title: "🎉 Hi~ 欢迎来到橙子工艺官网, 如果你在网站中发现任何问题请联系 AliceIClodia.",
                close: ""
              }),
              createVNode(_component_appHeader),
              createVNode(_component_NuxtLoadingIndicator, { color: "#F8BB77" }),
