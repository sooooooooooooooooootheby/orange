	...
	<div>
		...
		<div class="relative z-1 flex flex-col items-center gap-4 md:gap-12 px-4">
			<div class="w-full h-screen flex flex-col items-center justify-center gap-2">
				<div class="relative">
					<p class="font-bold text-6xl text-default"><span class="text-[#FccA96]">橙</span>子工艺</p>
					<logo class="absolute -right-18 -top-20 w-42" />
				</div>
				<p class="text-default2">一个不删档的1.21.x原版增强服务器!</p>
				<NuxtLink
					to="/docs"
